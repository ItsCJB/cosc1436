...
{ //Prompt user for radius of circle
    ...
    //Type coercion - compiler implicitly converts an expression's type to a larger type
        ...
        // Type coercion - compiler implicityly converts an expression's type to a larger type

        // Type casting - you explicituly convert an expression's type to another type
    ...
    intDivison = 10.0 / 3;       //double / int ==> double 

    intDivision = left / right;  //int / int ==> int 

    intDivision = 10 / 3.0; // int / double ==> double

    intdivison = (double)left / right; // double / int=> double 
    ...
    //
    //celi(x) => Smallest possible integral value >= X
